...
$(document).ready(function () {
    ...
    function createTable() {
        ...
        $.each(empolyeeList, function (key, data) {
            ...
            // 作品名
                ...
                td += '<td class="td1">' + empolyeeList[key].p_name + '</td>';
           
            // 成品圖
           
                td += '<td class="td2">'+ empolyeeList[key].p_photo + '</td>';
           
            // 權限
            switch (empolyeeList[key].p_filename_private) {
            ...
            switch (empolyeeList[key].u_right) {
                case "1":
                  ...
                  break;
                case "2":
                  td += '<td>' +'<a class="btn btn-success text-white myModifyBtn">修改</a>' + '<a class="btn btn-danger text-white myDeleteBtn">刪除</a>';
                  break;
                default:
                  break;
            } 
    ...
    function downloadAndUpateTable() {  
        ...
        $.get("makediy{{Auth::user()->u_id}}", function (dataFromServer) {
